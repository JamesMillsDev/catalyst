...
local module = {name="",prj_dependencies={},includes={},additional_files={},unified_links={},split_links={},link_dirs={},packages={}}
...
function module.parse(lines)
    local new_module = module:new{name="",prj_dependencies={},includes={},additional_files={},unified_links={},split_links={},link_dirs={},packages={}}
...
function module:get_packages(lines)
    line = remove_tab(lines[1])

    if contains(line, ids.packages) then
        line = value_from_len(line, ids.packages, 3, 2)
